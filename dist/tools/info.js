...
export function registerInfo(server) {
    server.tool("vv_info", "Get video info without downloading the full video. Returns title, duration, creator, views, likes, description, and hashtags. Use this before vv_watch to check what a video contains. Much faster than vv_watch — takes 2-3 seconds.", {
        ...
        try {
            ...
            const hashtags = [
                ...
                ...(raw.tags || []).filter((t) => t.startsWith("#")),
            ];
            result = {
