...
export function registerWatch(server) {
    server.tool("vv_watch", `Watch any social video — YouTube, Instagram (Reels/posts), TikTok, Twitter/X, Facebook, Reddit, or a local file. Paste the URL and Claude will extract frames + platform metadata so you can analyze what's in the video.
