...
export function registerTranscript(server) {
    server.tool("vv_transcript", "Extract the transcript/captions from a YouTube, TikTok, or Instagram video WITHOUT downloading the full video file. Returns the full text with timestamps. Much faster than vv_watch — no video download needed. Great for summarizing long videos, extracting quotes, or analyzing what was said.", {
